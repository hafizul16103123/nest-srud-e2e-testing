...
export const userControllerTest=()=>{
  return describe('UsersController', () => {
    ...
    describe('createUser', () => {
      ...
      it('should create a Patient also', async () => {
    ...
    describe('updateUser', () => {
      it('should return an user with updated value', async () => {
        ...
        const response = await request(httpServer).put(`/users/${user._id.toString()}`).send(updateUserRequest);
